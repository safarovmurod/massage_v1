...
export function translateAuthError(error, t) {
  ...
  // Supabase пишет "at least N characters" — N зависит от настройки в кабинете
  if (code === 'weak_password' || /at least \d+ characters/.test(msg) || msg.includes('password should be')) {
