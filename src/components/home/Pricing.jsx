        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-7 max-w-[800px] mx-auto">
          ...
          <ScrollReveal>
            ...
            >
              ...
              <motion.a href={getWhatsAppLink(lang, 'home')} target="_blank" rel="noopener noreferrer"
          ...
          <ScrollReveal delay={0.15}>
            ...
            >
              ...
              <motion.a href={getWhatsAppLink(lang, 'clinic')} target="_blank" rel="noopener noreferrer"
                whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
